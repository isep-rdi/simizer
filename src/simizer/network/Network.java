...
/**
 *  Network simulation class. A set of nodes is associated to this network.
 * The class can be set up to use the arrival law to simulate node arrivals.
...
public class  Network extends EventProducer  {
    ...
    public  void send(Node source, Node dest, Request r, long timestamp) {
      ...
      // System.out.println("@@@@@@@@@@@@@@"+ "Source :" +source+" Dest :"+dest+" Request :"+r+" timestamp :"+timestamp );
