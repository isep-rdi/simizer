...
/**
 * Gaussian - distributed integer generator.
 * Values are set between 0 and nbParams following a Gaussian distribution centered on 
 * nbParams / 2. The standard deviation is set by using the setParam method, but defaults
 * to the mean divided by 2.
 * @author isep
 */
