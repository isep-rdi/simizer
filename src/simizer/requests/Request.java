...
public class Request  {
    public static final RequestComparator requestComparator = new RequestComparator();
    ...
    long procTime,artime, ftime, delay=0,fwdTime=0;
    double cost=0.0;
    ...
    public Request(long id, int typeId, long artime, String params, long procTime, String type, long nbInst) {
        this.id = id;
        this.artime = artime;
        this.type = type;
        this.typeId = typeId;
    ...
    public Request(long id,long artime, long procTime,int node,float cost,String params) {
        ...
        /**
         * Only used in Cawa policies (historical)
         * Should be deleted
         * @deprecated 
         * @param id
         * @param artime
 ...
 public static Request vectorToRequest(double[] req){
        String tmp="";
        for(int i=0; i<req.length;i++)  tmp=tmp+req[i]+",";
    ...
    public Vector requestToVectorH () {
        ...
        for(int i=1;i<str.length; i+=2) {
         ...
         Vector monVec= new Vector(d);
                 //System.out.println(monVec.toString());
