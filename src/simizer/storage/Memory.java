...
/**
 * This class implements a memory controller.
 * places the resources in memory, accounts for free, available and used memory.
 * @author slefebvr
 */
public class Memory extends StorageElement {
    ...
    /**
     * This method puts the specified resource in memory.
