...
public class Simulation {
    ...
    public void runSim() throws Exception {
        ...
        for(Node n: nodeMap.values()) {
            /**
             * @TODO quick fix for now, must create a start() method
             * in Node class.
             */
            
            if(n instanceof VM) ((VM) n).startVM();
        }
    ...
    /**
     * Adds the node to the simulation by adding it to the specified network.
     * Sets up the channel for producing events if needed.
     * @param n
     * @param networkName 
     */
