...
/**
 * This class simulates a web user client machine. It is configured by three
 * laws determining the parameters selection, think time , session duration.
 *
 * Clients will generally send theirs requests to the LBNode corresponding to
 * their attributes DC.
 *
 * @see LBNode
...
public class ClientNode extends Node {
  ...
  /**
   * three laws determining: parameters selection, think time , session
   * duration.
   *
   * @param requestLaw
   * @param thinkTimeLaw
  ...
  /**
   * On request reception, the node prints out the received request and gets the
   * next think time, then schedules a request if it does not exceed the
   * duration law.
   *
   * @param timestamp
   * @param m
