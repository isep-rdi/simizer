...
/**
 * This class is used for figuring a process. 
 * It is a composition of tasks, that is passed to the processing unit for execution.
 * Tasks in the TaskSession are executed in order by the processing unit,
 * by by successive calls to getNextTask();
 * @see VM
 * @see ProcessingUnit
 * 
...
public class TaskSession {
    ...
    /**
     * Prints out the task list, for debugging purpose
     */ 
//    public void printTaskSession() {
